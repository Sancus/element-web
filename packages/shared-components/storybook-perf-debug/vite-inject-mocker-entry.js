import { i as __esmMin, n as process$1, t as init_dist } from "./assets/dist-DHqTAwVy.js";
import { n as init_preload_helper, t as __vitePreload } from "./assets/preload-helper-4Suo0lxq.js";
//#region ../../node_modules/.pnpm/storybook@10.5.2_@types+react@19.2.17_prettier@2.8.8_react@19.2.8/node_modules/storybook/dist/mocking-utils/mocker-runtime.js
...
function C(n = !1) {
	let e = typeof process$1 < "u" ? process$1 : void 0, i = e?.env || {}, g = e?.argv || [];
...
__esmMin((() => {
	...
	try {
		let { getPromiseDetails, kPending, kRejected } = process$1.binding("util");
